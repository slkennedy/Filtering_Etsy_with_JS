...
var finalAvg = average.toFixed(2);
console.log("The average price is $" + finalAvg);


//Q2 - Array of items w/price btw $14 & $18
var range =
items.filter(function(prices){
  if (prices.currency_code === "USD")
    {
      if(prices.price > 14.00 && prices.price < 18.00)
      {return prices.title;}
    }
})
console.log("Items that cost between $14 and $18 USD:" + range)


// Q3 - Items with GBP Currency
var british = [];
items.filter(function(currency){
  return currency.currency_code === "GBP";
}).forEach(function(display){
  console.log("The " + display.title + " costs £ " + display.price);
})


//Q4 - Items made of wood
items.filter(function(material){
  return material.materials.indexOf("wood") >= 0;
}).forEach (function(display){
  console.log(display.title + " is made of wood.");
})


//Q5 - Items made of 8 items or more
items.filter(function(contents){
  return contents.materials.length >=8;
}).forEach(function(contents){
  console.log(contents.title + " has " + contents.materials.length + " materials: \n");
contents.materials.forEach(function(contents){
...
//Q6 - Calculate # of items made by seller
var crafty =
items.filter(function(maker){
  return maker.who_made ==="i_did";
})
console.log(crafty.length + " were made by their sellers");
